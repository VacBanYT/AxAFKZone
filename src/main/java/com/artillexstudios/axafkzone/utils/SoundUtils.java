...
import static com.artillexstudios.axafkzone.AxAFKZone.BUKKITAUDIENCES;
...
public class SoundUtils {
    ...
    public static void playSound(@NotNull Player player, @Nullable String sound) {
        ...
        try {
            ...
            Bukkit.getConsoleSender().sendMessage(StringUtils.formatToString("&#FF0000[AxCrates] The sound %sound% does not exist, this is a configuration issue!".replace("%sound%", sound)));
        }
    }
}
